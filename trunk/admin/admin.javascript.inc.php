											...
											<table class="form-table">
												<tr valign="top">
													...
													<td>
														...
														<label><input type="radio" name="abovethefold[jsdelivery_scriptloader]" value="html5"<?php if ($jsProxy && isset($options['jsdelivery_scriptloader']) && $options['jsdelivery_scriptloader'] === 'html5') { print ' checked'; } ?> <?php if (!$jsProxy) { print ' DISABLED'; } ?>> <strong>BETA</strong> little-loader + HTML5 Web Worker and Fetch API based script loader with localStorage cache</label>
