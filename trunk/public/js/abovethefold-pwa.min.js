...
a]).then(function(a){b(a.status)})},[a,b])},r=function(a,b,c){m(function(a,b){n([3,a,b]).then(function(a){c(a.status)})},[a,b])};if(e.offline=function(a){return(new Promise(function(b){p(a,b)}))["catch"](function(){})},e.push=function(a,b){return(new Promise(function(c){r(a,b,c)}))["catch"](function(){})},f[7]){var q=function(){var a=this.getAttribute("href");a&&p(a,function(){})};e[14](function(){if(d.jQuery)d.jQuery(function(a){a("body").on("mousedown","a",q)});else for(var a=Array.prototype.slice.call(g.getElementsByTagName("a")),
