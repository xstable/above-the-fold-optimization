...
void 0!==b.href?b:m(b),"blob:"===b.protocol)b=!1;else{if(f){a=f.length;for(var c=0;c<a;c++)if(-1!==b.href.indexOf(f[c].href)){b=!1;break a}}b=b.host!==y.host}a=!!b&&"css"}return a}}return!1}function N(a){a="object"==typeof a&&void 0!==a.href?a:m(a);if("blob:"===a.protocol)return!0;if(x){for(var b=!1,c=x.length,e=0;e<c;e++)if(-1!==a.href.indexOf(x[e])){b=!0;break}if(!b)return console.log("Abtf.proxy()","ignore",d[29](a.href),"not on include list"),!0}if(r)for(c=r.length,e=0;e<c;e++)if(-1!==a.href.indexOf(r[e]))return console.log("Abtf.proxy()",
"ignore",d[29](a.href),"on exclude list:",r[e]),!0;return!1}function M(a){a="object"==typeof a&&void 0!==a.href?a:m(a);if("blob:"===a.protocol)return!0;if(t){console.log(222,t);for(var b=!1,c=t.length,e=0;e<c;e++)if(-1!==a.href.indexOf(t[e])){b=!0;break}if(!b)return console.log("Abtf.proxy()","ignore",d[29](a.href),"not on include list"),!0}if(u)for(c=u.length,e=0;e<c;e++)if(-1!==a.href.indexOf(u[e]))return console.log("Abtf.proxy()","ignore",d[29](a.href),"on exclude list:",u[e]),!0;return!1}function H(a,
b){var c="object"==typeof a&&void 0!==a.href?a:m(a);if("blob:"===c.protocol)return!1;if(f&&!0!==b)for(var e=f.length,d=0;d<e;d++)if(-1!==c.href.indexOf(f[d].href))return!1;return c.host!==y.host}function F(a,b){return"css"===b?z.replace("{PROXY:URL}",escape(a)).replace("{PROXY:TYPE}",escape(b)):"js"===b?z.replace("{PROXY:URL}",escape(a)).replace("{PROXY:TYPE}",escape(b)):void 0}function m(a){var b=document.createElement("a");return b.href=a,b}var z,E,G=!1,I=!1,w=!1,t=!1,u=!1,x=!1,r=!1,B=!1,C=[],D=
[],n=[],v={},f=[];d[27]=function(a){if(void 0===b)var b=!1;if((z=a[0]&&-1!==a[0]?a[0]:b)||console.error("Abtf.proxy()","no proxy url",a),G=!(!a[1]||-1===a[1])&&a[1],I=!(!a[2]||-1===a[2])&&a[2],(w=!(!a[9]||-1===a[9])&&a[9])&&f.push(w),t=!(!a[5]||-1===a[5])&&a[5],u=!(!a[6]||-1===a[6])&&a[6],x=!(!a[7]||-1===a[7])&&a[7],r=!(!a[8]||-1===a[8])&&a[8],a[3]){B=!0;for(b=0;b<a[3].length;b++)"regex"===a[3][b][0]?(n.push([a[3][b][2],a[3][b][3],a[3][b][1]]),a[3][b][4]&&(v[a[3][b][0]]=a[3][b][4],-1===f.indexOf(a[3][b][4])&&
f.push(a[3][b][4]))):(C.push(a[3][b][0]),D.push(a[3][b][1]),a[3][b][4]&&(v[a[3][b][0]]=a[3][b][4],-1===f.indexOf(a[3][b][4])&&f.push(a[3][b][4])));E=!(!a[4]||-1===a[4])&&a[4]}if(0===f.length)f=!1;else for(a=f.length,b=0;b<a;b++)f[b]=m(f[b])};var l={Element:"undefined"!=typeof Element&&Element,Document:"undefined"!=typeof Document&&Document},J={},K={},g;for(g in l)l.hasOwnProperty(g)&&l[g]&&(J[g]=l[g].prototype.appendChild,K[g]=l[g].prototype.insertBefore);var y=document.createElement("a");y.href=
