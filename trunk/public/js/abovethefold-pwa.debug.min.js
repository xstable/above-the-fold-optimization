Abtf[0](function(c,b){if(b.offline=function(){return{then:function(){}}},"serviceWorker"in c.navigator&&b[8]&&b[8][0]){var d=c.document,e=b[8];if(e[3]){var f,g=function(){b[15](function(){if(f!==navigator.onLine&&d.body){if(navigator.onLine){if(void 0===f)return;console.info("Abtf.offline() \u27a4 connection restored");d.body.classList.remove("offline")}else console.warn("Abtf.offline() \u27a4 connection offline"),d.body.classList.add("offline");f=!!navigator.onLine}})};c.addEventListener("online",
g);c.addEventListener("offline",g);g()}var h=function(){navigator.serviceWorker.controller.postMessage([1,b[8][2],b[8][4],b[8][5]])};navigator.serviceWorker.ready.then(function(){navigator.serviceWorker.controller?h():navigator.serviceWorker.addEventListener("controllerchange",function(){h()});console.info("Abtf.pwa() \u27a4 service worker ready")});e[6]&&navigator.serviceWorker.register(e[0],{scope:e[1]}).then(function(a){return new Promise(function(b,c){a.installing?a.installing.addEventListener("statechange",
function(a){"installed"==a.target.state?(console.info("Abtf.pwa() \u27a4 service worker loaded"),b()):(console.warn("Abtf.pwa() \u27a4 service worker",a.target.state),"redundant"==a.target.state&&c())}):(console.info("Abtf.pwa() \u27a4 service worker loaded"),b())})})["catch"](function(a){throw a;});navigator.serviceWorker.addEventListener("message",function(a){a&&a.data&&a.data instanceof Array&&2===a.data[0]&&d.body&&(a=new CustomEvent("sw-update",{detail:{url:a.data[1]}}),c.dispatchEvent(a))});
