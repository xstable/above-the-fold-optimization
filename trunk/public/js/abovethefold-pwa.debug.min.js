...
var m=function(a,b){navigator.serviceWorker.controller?a.apply(c,b):navigator.serviceWorker.ready.then(function(){a.apply(c,b)})},n=function(a,b){return new Promise(function(k){var c=new MessageChannel;c.port1.onmessage=function(b){b.data&&b.data.error?console.info("Abtf."+a+"() \u27a4 error",b.data.error):k(b.data)};navigator.serviceWorker.controller.postMessage(b,[c.port2])})},p=function(a,b){m(function(a){n("offline",[2,a]).then(function(a){b(a.status)})},[a,b])};if(d.offline=function(a){return(new Promise(function(b){p(a,
b)}))["catch"](function(b){console.info("Abtf.offline() \u27a4 error",b,a)})},d.push=function(a,b){return(new Promise(function(c){m(function(a,b){n("push",[3,a,b]).then(function(a){c(a.status)})},[a,b])}))["catch"](function(c){console.info("Abtf.push() \u27a4 error",c,a,b)})},e[7]){var q=function(){var a=this.getAttribute("href");a&&p(a,function(){})};d[14](function(){if(c.jQuery)c.jQuery(function(a){a("body").on("mousedown","a",q)});else for(var a=Array.prototype.slice.call(f.getElementsByTagName("a")),
b=a.length,d=0;d<b;d++)a[d].onmousedown=q})}}});
