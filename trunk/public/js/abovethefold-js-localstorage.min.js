...
a)}):b([a.status,a.statusText]))},e)["catch"](e);e=a.timeout||self.c;isNaN(e)&&(e=self.c);d=setTimeout(function(){c||b("timeout")},e)}else{var f=new XMLHttpRequest;f.open("GET",a.url,!0);f.responseType="text";f.onreadystatechange=function(){c||4===f.readyState&&(200!==f.status?b(f.statusText):b(!1,f.responseText))};f.onerror=function(){c||b(f.statusText)};e=a.timeout||self.c;isNaN(e)&&(e=self.c);d=setTimeout(function(){if(!c){try{f.abort()}catch(k){}b("timeout")}},e);f.send(null)}};self.F=function(a,
b,c){b?(b instanceof Array||"object"!=typeof b||(b=b.toString()),self.postMessage([2,a.f,b])):self.postMessage([1,a.f,c])};self.onmessage=function(a){a=a.data;if(a instanceof Array)for(var b=a.length,c=0;c<b;c++)"object"==typeof a[c]&&void 0!==a[c].url&&void 0!==a[c].f&&self.o(a[c]);else{if("object"!=typeof a||void 0===a.url||void 0===a.f)throw Error("Web Worker Script Loader: Invalid resource object");self.o(a)}}}.toString().replace(/^function\s*\(\s*\)\s*\{/,"").replace(/\}$/,""),m={J:t(p),b:!1,
C:0,l:[],start:function(){this.b=new Worker(this.J);this.b.addEventListener("message",this.w);this.b.addEventListener("error",this.handleError)},stop:function(){this.b&&(this.b.removeEventListener("message",this.w),this.b.removeEventListener("error",this.handleError),this.b.terminate(),this.b=!1)},w:function(a){a=a.data;var b=a[1];void 0!==m.l[b]&&(1!==parseInt(a[0])?parseInt(a[0]):m.l[b].H(a[2]))},handleError:function(){0},A:function(a,b){this.b||this.start();a=h[28](a);var c=parseInt(this.C);this.C++;
this.l[c]={url:a,H:b};this.b.postMessage({url:a,f:c})}};if(m.start(),l.addEventListener("beforeunload",function(){if(m.stop(),0<n.length)for(var a=n.length,b=0;b<a;b++)try{URL.revokeObjectURL(n[b])}catch(c){0}}),h[16])h[16](function(){d.clear(!0)},{timeout:3E3});else{var q,p=function(){q&&clearTimeout(q);q=setTimeout(function(){d.clear(!0)},2E3)};p();h[20](p)}h[23]=function(a,b){r(function(){var c=d.j(a);c?h[21](c,b):h[21](a,function(){b();m.A(a,function(b){b&&d.B(a,b)})})})};h[25]=function(a){r(function(){d.I(a)})};
h[24]=function(a){return d.j(a)||(m.A(a,function(b){b&&d.B(a,b)}),a)}}});
