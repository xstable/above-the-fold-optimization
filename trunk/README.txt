...
* Added: javascript optimization option to load javascript files in parallel in a HTML5 Web Worker.
* Added: save scripts in HTML5 localStorage to achieve optimal speed on mobile devices ([reference](http://www.stevesouders.com/blog/2011/03/28/storager-case-study-bing-google/))
